# CLAUDE.md — lmntea-router harness guide (Claude Code)

> **Claude Code compatibility:** This file mirrors `AGENTS.md` — canonical is `AGENTS.md`. Both are tracked and kept identical except for this header. If they diverge, `AGENTS.md` wins.
