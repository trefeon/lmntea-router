...
/**
 * Generated by scripts/import-provider.ts for provider "aimlapi"
 * Sample model: aimlapi/claude-3-5-sonnet-20241022
 * Citations: reference/OmniRoute/open-sse/config/providers/registry/aimlapi/index.ts:4 | reference/9router/open-sse/providers/registry (baseUrl/format)
 * Provider citations: reference/OmniRoute/open-sse/config/providers/registry/aimlapi/index.ts:4
 */

describe('import-provider generated: aimlapi', () => {
  const sampleId = 'aimlapi/claude-3-5-sonnet-20241022'
  const spec = MODEL_REGISTRY[sampleId]

  it('provider exists in PROVIDERS with baseUrl', () => {
    const prov = PROVIDERS['aimlapi']
    expect(prov).toBeDefined()
    expect(prov.baseUrl).toMatch(/^https?:\/\//)
    // citation: reference/OmniRoute/open-sse/config/providers/registry/aimlapi/index.ts:4
  })

  it('model exists in MODEL_REGISTRY with sorted citations', () => {
    expect(spec).toBeDefined()
    expect(spec.id).toBe(sampleId)
    expect(spec.provider).toBe('aimlapi')
  ...
  it('vision gate: supportsVision citation preserved', () => {
    if (!spec) return
    // visionGate=unknown from source reference/OmniRoute/open-sse/config/providers/registry/aimlapi/index.ts:4 | reference/9router/open-sse/providers/registry (baseUrl/format)
    expect(spec).toBeDefined()
  })
  ...
  it('relay vs direct tier: provider relay flag coherent', () => {
    const prov = PROVIDERS['aimlapi']
    // relay=true passthrough=true citation: reference/OmniRoute/open-sse/config/providers/registry/aimlapi/index.ts:4
