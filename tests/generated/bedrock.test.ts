...
/**
 * Generated by scripts/import-provider.ts for provider "bedrock"
 * Sample model: bedrock/anthropic.claude-sonnet-4-5
 * Citations: reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4 | reference/9router/open-sse/providers/registry (baseUrl/format)
 * Provider citations: reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4 | reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4
 */

describe('import-provider generated: bedrock', () => {
  const sampleId = 'bedrock/anthropic.claude-sonnet-4-5'
  const spec = MODEL_REGISTRY[sampleId]

  it('provider exists in PROVIDERS with baseUrl', () => {
    const prov = PROVIDERS['bedrock']
    expect(prov).toBeDefined()
    expect(prov.baseUrl).toMatch(/^https?:\/\//)
    // citation: reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4 | reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4
  })
  ...
  it('vision gate: supportsVision citation preserved', () => {
    if (!spec) return
    // visionGate=unknown from source reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4 | reference/9router/open-sse/providers/registry (baseUrl/format)
    expect(spec).toBeDefined()
  })
  ...
  it('relay vs direct tier: provider relay flag coherent', () => {
    const prov = PROVIDERS['bedrock']
    // relay=true passthrough=true citation: reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4 | reference/OmniRoute/open-sse/config/providers/registry/bedrock/index.ts:4
