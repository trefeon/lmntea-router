...
/**
 * Generated by scripts/import-provider.ts for provider "vertex"
 * Sample model: vertex/gemini-3.1-pro-preview
 * Citations: reference/9router/open-sse/providers/registry/vertex.js:2 | reference/9router/open-sse/providers/registry (baseUrl/format)
 * Provider citations: reference/9router/open-sse/providers/registry/vertex.js:2
 */

describe('import-provider generated: vertex', () => {
  const sampleId = 'vertex/gemini-3.1-pro-preview'
  const spec = MODEL_REGISTRY[sampleId]

  it('provider exists in PROVIDERS with baseUrl', () => {
    const prov = PROVIDERS['vertex']
    expect(prov).toBeDefined()
    expect(prov.baseUrl).toMatch(/^https?:\/\//)
    // citation: reference/9router/open-sse/providers/registry/vertex.js:2
  })
  ...
  it('vision gate: supportsVision citation preserved', () => {
    if (!spec) return
    // visionGate=unknown from source reference/9router/open-sse/providers/registry/vertex.js:2 | reference/9router/open-sse/providers/registry (baseUrl/format)
    expect(spec).toBeDefined()
  })
  ...
  it('relay vs direct tier: provider relay flag coherent', () => {
    const prov = PROVIDERS['vertex']
    // relay=false passthrough=true citation: reference/9router/open-sse/providers/registry/vertex.js:2
