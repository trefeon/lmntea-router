...
/**
 * Generated by scripts/import-provider.ts for provider "deepseek"
 * Sample model: deepseek/deepseek-v4-pro
 * Citations: reference/OmniRoute/src/shared/constants/modelSpecs.ts:647 | universal_protocol_translation_spec.md:effort table (thinking caps)
 * Provider citations: reference/OmniRoute/open-sse/config/providers/registry/deepseek/index.ts:4 | reference/OmniRoute/src/shared/constants/modelSpecs.ts:647
 */

describe('import-provider generated: deepseek', () => {
  const sampleId = 'deepseek/deepseek-v4-pro'
  ...
  it('provider exists in PROVIDERS with baseUrl', () => {
    ...
    // citation: reference/OmniRoute/open-sse/config/providers/registry/deepseek/index.ts:4 | reference/OmniRoute/src/shared/constants/modelSpecs.ts:647
  })
  ...
  it('vision gate: supportsVision citation preserved', () => {
    if (!spec) return
    // visionGate=unknown from source reference/OmniRoute/src/shared/constants/modelSpecs.ts:647 | universal_protocol_translation_spec.md:effort table (thinking caps)
    expect(spec).toBeDefined()
  })
  ...
  it('relay vs direct tier: provider relay flag coherent', () => {
    const prov = PROVIDERS['deepseek']
    // relay=false passthrough=false citation: reference/OmniRoute/open-sse/config/providers/registry/deepseek/index.ts:4 | reference/OmniRoute/src/shared/constants/modelSpecs.ts:647
  ...
  it('app.request integration: POST /v1/chat/completions normalizes via clamp/sanitize/thinking', async () => {
    ...
    if (res.status === 501) {
      ...
      if (normalized) expect(Number(normalized)).toBeLessThanOrEqual(384000)
    }
  })
})
