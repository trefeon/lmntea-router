...
/**
 * Generated by scripts/import-provider.ts for provider "anthropic"
 * Sample model: anthropic/claude-opus-4-5
 * Citations: reference/OmniRoute/src/shared/constants/modelSpecs.ts:276 | universal_protocol_translation_spec.md:effort table (thinking caps)
 * Provider citations: reference/OmniRoute/open-sse/config/providers/registry/anthropic/index.ts:5 | reference/OmniRoute/src/shared/constants/modelSpecs.ts:276
 */

describe('import-provider generated: anthropic', () => {
  const sampleId = 'anthropic/claude-opus-4-5'
  ...
  it('provider exists in PROVIDERS with baseUrl', () => {
    ...
    // citation: reference/OmniRoute/open-sse/config/providers/registry/anthropic/index.ts:5 | reference/OmniRoute/src/shared/constants/modelSpecs.ts:276
  })
  ...
  it('model exists in MODEL_REGISTRY with sorted citations', () => {
    ...
    expect(spec.maxOutputTokens).toBe(32768)
  })
  ...
  it('vision gate: supportsVision citation preserved', () => {
    if (!spec) return
    // visionGate=true from source reference/OmniRoute/src/shared/constants/modelSpecs.ts:276 | universal_protocol_translation_spec.md:effort table (thinking caps)
    expect(spec).toBeDefined()
  })
  ...
  it('relay vs direct tier: provider relay flag coherent', () => {
    const prov = PROVIDERS['anthropic']
    // relay=false passthrough=false citation: reference/OmniRoute/open-sse/config/providers/registry/anthropic/index.ts:5 | reference/OmniRoute/src/shared/constants/modelSpecs.ts:276
  ...
  it('app.request integration: POST /v1/chat/completions normalizes via clamp/sanitize/thinking', async () => {
    ...
    if (res.status === 501) {
      ...
      if (normalized) expect(Number(normalized)).toBeLessThanOrEqual(32768)
    }
  })
})
