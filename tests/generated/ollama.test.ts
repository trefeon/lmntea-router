...
/**
 * Generated by scripts/import-provider.ts for provider "ollama"
 * Sample model: ollama/gpt-oss:120b
 * Citations: reference/9router/open-sse/providers/registry/ollama.js:2 | reference/9router/open-sse/providers/registry (baseUrl/format)
 * Provider citations: reference/9router/open-sse/providers/registry/ollama.js:2
 */

describe('import-provider generated: ollama', () => {
  const sampleId = 'ollama/gpt-oss:120b'
  ...
  it('provider exists in PROVIDERS with baseUrl', () => {
    ...
    // citation: reference/9router/open-sse/providers/registry/ollama.js:2
  })
  ...
  it('vision gate: supportsVision citation preserved', () => {
    if (!spec) return
    // visionGate=unknown from source reference/9router/open-sse/providers/registry/ollama.js:2 | reference/9router/open-sse/providers/registry (baseUrl/format)
    expect(spec).toBeDefined()
  })
  ...
  it('relay vs direct tier: provider relay flag coherent', () => {
    const prov = PROVIDERS['ollama']
    // relay=false passthrough=false citation: reference/9router/open-sse/providers/registry/ollama.js:2
